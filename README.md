...
#### 📅 2026-07-28 - SVG Path Purifier

> 🇨🇳 **SVG路径净化器** - 一键清除SVG中“有害不可见”属性的净化器——让你的动效跑起来、SSR构建成功、设计师睡得着。

*Designers are manually deleting `fill="none"` and `stroke="none"` from exported SVGs—17 times today, across 3 Figma plugins, because every auto-export leaks invisible but *render-blocking* empty attributes.*

You know that moment when you open an SVG file and see six lines of `<g opacity="0" visibility="hidden" style="display:none">` wrapping a single path? Not malicious. Not even wrong—just *leaked*. Figma exports what its internal renderer see...

[📖 Read Full Diary](01_Work_Log/2026-07-28-Diary.md) · [🛠️ Get Tool](02_Toolbox/Design%20Alchemy/2026-07-28_SVG_Path_Purifier/main.py)
